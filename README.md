...
```text
.
├── Titanic/               # Práctica de clasificación (Análisis y modelo Titanic)
│   ├── Titanic.ipynb      # Notebook con análisis exploratorio y modelo
│   └── requirements.txt   # Dependencias específicas del entorno
└── README.md
